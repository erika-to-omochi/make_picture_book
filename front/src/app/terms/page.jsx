export default function TermsOfServicePage() {
  return (
    <article className="mx-4 pb-16 pt-4 *:my-4 md:container md:m-auto md:max-w-[800px] leading-loose">
      ...
      <section>
        <h2 className="font-bold my-4">本規約への同意</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">利用登録</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">登録拒否</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">未成年による利用</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">ログイン情報の管理</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">コンテンツのご利用</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">遅延損害金</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">ユーザーの投稿</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">広告の表示</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">禁止事項</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">換金行為の禁止</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">反社会的勢力の排除</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">利用制限</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">本サービスの提供の停止</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">退会</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">保証の否認</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">免責</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">サービス内容の変更</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">利用規約の変更</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">個人情報の取扱い</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">通知または連絡</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">権利義務の譲渡</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">事業譲渡</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">適用関係</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">分離可能性</h2>
        <p className="indent-6">
      ...
      <section>
        <h2 className="font-bold my-4">準拠法・裁判管轄</h2>
        <p className="indent-6">
        ...
        <p className="mt-6">2024年12月02日 制定</p>
      </section>
    </article>
  );
}
