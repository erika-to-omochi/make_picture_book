...
const Header = ({ userName }) => {
  ...
  return (
    <header className="header flex items-center justify-between p-4 bg-[#494444] text-white relative">
      <div className="logo">
        <Link href="/">
